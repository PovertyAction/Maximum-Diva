...
cat("  Running heterogeneous effects models for marital attainment... \n\n")
...
write_rds(married_hetero_results, "__data/results/married_hetero_results.rds")
